...
void LilyGo_AMOLED::setAddrWindow(uint16_t xs, uint16_t ys, uint16_t xe, uint16_t ye)
{
    ...
    ye += _offset_y;
    lcd_cmd_t t[3] = {
        {LCD_CMD_CASET, {(uint8_t)((xs >> 8) & 0xFF), (uint8_t)(xs & 0xFF), (uint8_t)((xe >> 8) & 0xFF), (uint8_t)(xe & 0xFF)}, 0x04},
        {LCD_CMD_RASET, {(uint8_t)((ys >> 8) & 0xFF), (uint8_t)(ys & 0xFF), (uint8_t)((ye >> 8) & 0xFF), (uint8_t)(ye & 0xFF)}, 0x04},
        {LCD_CMD_RAMWR, {0x00}, 0x00},
    };
